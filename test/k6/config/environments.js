...
export const environments = {
  ...
  vps: {
    baseUrl: __ENV.VPS_WS_URL || 'wss://api.yourdomain.com',
    httpUrl: __ENV.VPS_API_URL || 'https://api.yourdomain.com',
    loadTestToken: __ENV.LOAD_TEST_TOKEN || '',
  },
  staging: {
    baseUrl: __ENV.STAGING_WS_URL || 'wss://staging.example.com',
    httpUrl: __ENV.STAGING_API_URL || 'https://staging.example.com',
    loadTestToken: __ENV.LOAD_TEST_TOKEN || '',
  },
  production: {
    baseUrl: __ENV.PRODUCTION_WS_URL || 'wss://api.example.com',
